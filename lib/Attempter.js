...
var Attempter = function(args){
  ...
  var performReconciliation = function(){
    ...
    // 1. clear both the in-memory queue and the redis queue
    ...
    var getUnits = function(){
      ...
      function(message){ // failure handler
        console.log("Attempter in namespace " + self.namespace + "failed to getPendingWorkUnits; retrying. Message was: " + message);
        // retry
        getUnits();
      })
    }
